...
class PickPlaceImageDataset(BaseImageDataset):
    def __init__(self,
            shape_meta: dict,
            dataset_path: str,
            horizon=1,
        ...
        if use_cache:
            ...
            #     store=zarr.MemoryStore()
            # )
            print('Loading ReplayBuffer zarr.')
            replay_buffer = ReplayBuffer.copy_from_path(
            dataset_path, keys=['robot_eef_pose','gripper_width', 'action','camera_0'])
    ...
    for key, shape in lowdim_shapes.items():
        ...
        if 'pose' in key and shape == (2,):
            ...
            if zarr_arr.ndim == 1:
                ...
                print(f"Reshaping gripper_width from {old_shape} to {new_shape}")
